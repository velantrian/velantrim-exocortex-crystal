"""Validate mixed D1 localization freshness after Spanish parity refresh."""
...
def main() -> int:
    ...
    for ok, label in (
        ...
        (documentation.get("latest_translation_refresh_issue") == 417, "latest refresh issue"),
    ...
    for marker in (
        ...
        "D1 Reader-dependent detail translations are `CURRENT` in German, French, Spanish and Russian",
    ...
    for marker in (
        ...
        "five other localized root README files and Reader-dependent detail packs",
        "reader_core_rc5_relation_candidates    = true",
    ):
    ...
    if errors:
        ...
        for error in errors:
            print(f"  - {error}")
        return 1
    print("D1 translation status consistent: German + French + Spanish + Russian CURRENT; 5 locales REFRESH_NEEDED")
    return 0
