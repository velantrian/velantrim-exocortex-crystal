"""Validate D4 project/grant/governance translation freshness after Hindi parity refresh."""
...
def main() -> int:
    ...
    if errors:
        ...
        for error in errors:
            print(f"  - {error}")
        return 1
    print("D4 translation status consistent: all 9 supported locales CURRENT; 0 REFRESH_NEEDED")
    return 0
