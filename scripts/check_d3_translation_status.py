"""Validate mixed D3 architecture/storage translation freshness after Italian parity refresh."""
...
def main() -> int:
    ...
    for marker in (
        ...
        "D3 Reader-dependent detail translations are `CURRENT` in German, French, Spanish, Italian and Russian",
    ...
    if errors:
        ...
        for error in errors:
            print(f"  - {error}")
        return 1
    print("D3 translation status consistent: German + French + Spanish + Italian + Russian CURRENT; 4 locales REFRESH_NEEDED")
    return 0
