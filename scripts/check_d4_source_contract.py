...
def main() -> int:
    ...
    required = {
        "docs/PROJECT_GRANT_AND_GOVERNANCE.md": (
            ...
            "budget change: none", "€50,000", "active=false", "RC-9",
            "dedicated_reader_core=false", "retrieval match", "candidate discovery",
            "candidate adjudication",
        ),
        "docs/GLOSSARY.md": (
            "physical L3", "strict Canon", "active=false", "funded delta",
            "submitted / under review / not awarded", "Reader Core RC-1",
            "Reader Core RC-2", "Reader Core RC-3", "Reader Core RC-4",
            "Reader Core RC-5", "EXTRACTED_PROPOSITION", "source owner",
            "POSSIBLE_CONTRADICTION", "EXCEPTION", "QUALIFICATION", "TENSION",
            "dedicated/full Reader Core",
        ),
        "docs/GRANT_NLNET_SCOPE.md": (
            "submitted / under review / not awarded", "budget change", "RC-9",
            "dedicated_reader_core", "existing pre-agreement baseline",
            "cannot later be rebilled", "Recall@5", "Precision@5",
            "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP", "candidate discovery",
            "candidate adjudication",
        ),
        "ROADMAP.md": (
            "submitted / under review / not awarded", "reader_core_rc1_skeleton",
            "reader_core_rc7_cross_document_links", "dedicated_reader_core", "RC-9",
            "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP", "candidate discovery",
            "candidate adjudication",
        ),
        "GOVERNANCE.md": (
    ...
    require(
        ...
        (
            "no award", "cannot be counted again", "active=false", "Reader RC-1",
            "Reader RC-7", "Reader RC-8", "Reader RC-9", "dedicated_reader_core",
            "Recall@5", "Precision@5", "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP",
    ...
    require(
        ...
        (
            "submitted / under review / not awarded", "€50,000", "not an approved budget",
            "RC-9", "cannot be paid for again", "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP",
        ),
        errors,
    )
    require(
        ...
        (
            "RC-9", "Recall@5", "Precision@5", "not presented as “94% accuracy”",
            "submitted / under review / not awarded", "dedicated_reader_core=false",
            "candidate discovery", "candidate adjudication",
        ),
        errors,
    )
    ...
    require(
        ...
        (
            ...
            "Recall@5", "Precision@5", "MRR", "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP",
            "Reviewer validation", "submitted / under review / not awarded",
    ...
    forbid(
        ...
        readme,
        (
            "94% accuracy", "semantic understanding is implemented",
    ...
    require(
        "documentation map", doc_map,
        ("Reader Core architecture contract", "Grant scope", "Baseline-funded delta matrix",
         "submitted / under review / not awarded", "D4"), errors,
    )

    state = (ROOT / "docs/ai/CURRENT_STATE.md").read_text(encoding="utf-8")
    require(
        "AI current state", state,
        (SOURCE, "reader_core_rc1_skeleton", "reader_core_rc7_cross_document_links",
         "dedicated_reader_core", "RC-9", "LEXICAL_BASELINE_EXPOSES_MEASURED_GAP",
         "NLnet remains submitted / under review / not awarded"), errors,
    )

    ledger = (ROOT / "docs/TRANSLATION_STATUS.md").read_text(encoding="utf-8")
    require(
        "translation ledger", ledger,
        (
            "## D4 — project / grant / glossary",
            "D4 Reader-dependent detail translations are `CURRENT` in Arabic, German, French, Spanish, Italian, Japanese, Simplified Chinese and Russian",
    ...
    require(
        ...
        ("Validate English D4 source contract", "python scripts/check_d4_source_contract.py"), errors,
    )
