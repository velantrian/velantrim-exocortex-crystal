...
`v0.1.0` · 🧪 **761 tests** · 🎯 **100% coverage** · 🐍 **pure-stdlib runtime** · ⚖️ **AGPL-3.0** · 🔒 **local-first**
...
| Gate | What it checks |
|---|---|
| **pytest** (761 tests, 100% coverage gate) | Core memory, pipeline, provenance, GDPR controls, ESM transitions, review queue |
...
- 761 passing tests and 100% coverage;
