...
`v0.1.0` · 🧪 **669 tests** · 🎯 **98% coverage** · 🐍 **pure-stdlib runtime** · ⚖️ **AGPL-3.0** · 🔒 **local-first**
...
| Gate | What it checks |
|---|---|
| **pytest** (669 tests, ≥ 95% coverage) | Core memory, pipeline, provenance, GDPR controls, ESM transitions, review queue |
...
- 669 passing tests and 98% coverage;
