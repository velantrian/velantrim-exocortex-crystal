...
# Project, grant और governance

physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof. PostgreSQL `active=false`.

NLnet: submitted / under review / not awarded. लगभग €50,000 planning only; budget change: none.
...
RC-1/RC-2 pre-agreement baseline हैं। dedicated multi-pass Reader future work है। security/legal/GDPR/native-speaker certification का दावा नहीं है।
