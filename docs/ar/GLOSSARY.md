...
physical L3 ليس strict Canon، وretrieval score ليس evidence. RC-1 = bounded evidence-linked skeleton. RC-2 = bounded Structural Document Map. Dedicated Reader Core = multi-pass runtime مستقبلي.
...
PostgreSQL `active=false`؛ €50,000 للتخطيط فقط.
