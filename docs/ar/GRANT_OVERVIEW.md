...
NLnet: submitted / under review / not awarded. نحو €50,000 للتخطيط فقط؛ budget change: none.
...
RC-1/RC-2 جزء من baseline قبل الاتفاق. الـReader المخصص multi-pass عمل مستقبلي. لا ندعي security/legal/GDPR/native-speaker certification.
