...
# Proyecto, financiación y gobernanza

physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof. PostgreSQL permanece `active=false`.

NLnet: submitted / under review / not awarded. Aproximadamente €50,000 es planificación; budget change: none.
...
RC-1/RC-2 son baseline pre-acuerdo. El Reader multi-pass dedicado sigue siendo trabajo futuro. No se afirma certificación security/legal/GDPR/native-speaker.
