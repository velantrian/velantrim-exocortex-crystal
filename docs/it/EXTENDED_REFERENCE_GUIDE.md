...
# Riferimento esteso Crystal

D5 distingue `CURRENT`, `RETIRED` e `ENGLISH_ONLY_BY_DESIGN`. physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof; import success != activation. PostgreSQL `active=false`.
...
RC-1/RC-2 sono fondamenta bounded implementate; il Reader multi-pass dedicato no. Grant: submitted / under review / not awarded; €50,000 planning only; budget change: none.
