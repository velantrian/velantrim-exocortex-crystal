...
physical L3 non è strict Canon; retrieval score non è evidence. RC-1 = skeleton evidence-linked bounded. RC-2 = Structural Document Map bounded. Dedicated Reader Core = futuro runtime multi-pass.
...
PostgreSQL `active=false`; €50,000 è solo pianificazione.
