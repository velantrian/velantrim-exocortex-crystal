...
L’inglese resta la fonte primaria in caso di conflitto. D2 e Quick Start restano `CURRENT`. Il README root completo e i documenti dettagliati dipendenti dal Reader in D1/D3/D4/D5 conservano il loro contenuto ricco precedente, ma richiedono un refresh semantico RC-4 e sono quindi `REFRESH_NEEDED`.

- Root README: `REFRESH_NEEDED` per RC-4
