...
L’inglese resta la fonte primaria in caso di conflitto. D2 e Quick Start restano `CURRENT`. Il README root completo e i documenti dettagliati dipendenti dal Reader in D1/D3/D4/D5 conservano il loro contenuto ricco precedente, ma richiedono un refresh semantico RC-3 e sono quindi `REFRESH_NEEDED`.

- Root README: `REFRESH_NEEDED` per RC-3
- D1: [Quick Start — CURRENT](./QUICKSTART.md), [Status — REFRESH_NEEDED](./STATUS.md), [Implementazione — REFRESH_NEEDED](./IMPLEMENTATION_STATUS.md)
- D2: [Reviewer Guide — CURRENT](./REVIEWER_GUIDE.md), [Safety/Privacy/Failures — CURRENT](./SAFETY_PRIVACY_AND_FAILURES.md)
- D3: [Architettura — REFRESH_NEEDED](./ARCHITECTURE_OVERVIEW.md), [Storage/Authority — REFRESH_NEEDED](./STORAGE_AND_AUTHORITY_BOUNDARIES.md)
- D4: [Grant Overview — REFRESH_NEEDED](./GRANT_OVERVIEW.md), [Glossario — REFRESH_NEEDED](./GLOSSARY.md)
