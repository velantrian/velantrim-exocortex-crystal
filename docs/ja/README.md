...
矛盾がある場合は英語版が一次ソースです。D2 と Quick Start は `CURRENT` のままです。完全版の root README と D1/D3/D4/D5 の Reader 依存詳細文書は従来の豊富な内容を保持していますが、RC-5 の意味更新が必要なため `REFRESH_NEEDED` です。

- Root README: RC-5 に対して `REFRESH_NEEDED`
