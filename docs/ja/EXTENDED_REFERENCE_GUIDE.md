...
D5 は `CURRENT`, `RETIRED`, `ENGLISH_ONLY_BY_DESIGN` を区別します。physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof; import success != activation。PostgreSQL `active=false`。
...
RC-1/RC-2 は実装済み bounded foundation、dedicated multi-pass Reader は未実装。Grant: submitted / under review / not awarded; €50,000 planning only; budget change: none.
