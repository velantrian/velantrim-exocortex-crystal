...
> 🌐 🇬🇧 [English](../STATUS.md) · 🇩🇪 **Deutsch** · 🇫🇷 [Français](../fr/STATUS.md) · 🇪🇸 [Español](../es/STATUS.md) · 🇮🇹 [Italiano](../it/STATUS.md)

**Statusdatum:** 30. Juli 2026  
**Aktueller Repository-Stand für diese Übersetzung:** `main@30e87df4`  
