...
# Pack de documentation Crystal en français

L’anglais reste la source principale et l’arbitre. Les traductions ne renforcent aucune affirmation de capacité, sécurité, droit ou financement.
...
- D5 `INVENTORY_PENDING`; des fichiers anciens peuvent être `REFRESH_NEEDED`.
