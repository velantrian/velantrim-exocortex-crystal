...
L’anglais reste la source primaire en cas de conflit. Les documents D1–D5 ci-dessous sont `CURRENT`; `REFRESH_NEEDED` signale une traduction devenue obsolète.

- D1 : [Quick Start](./QUICKSTART.md), [Status](./STATUS.md), [Implementation](./IMPLEMENTATION_STATUS.md)
- D2 : [Reviewer Guide](./REVIEWER_GUIDE.md), [Safety/Privacy/Failures](./SAFETY_PRIVACY_AND_FAILURES.md)
- D3 : [Architecture](./ARCHITECTURE_OVERVIEW.md), [Storage/Authority](./STORAGE_AND_AUTHORITY_BOUNDARIES.md)
- D4 : [Grant Overview](./GRANT_OVERVIEW.md), [Glossaire](./GLOSSARY.md)
