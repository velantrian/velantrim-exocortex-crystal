...
physical L3 n’est pas strict Canon; retrieval score n’est pas evidence. RC-1 = squelette evidence-linked borné. RC-2 = Structural Document Map bornée. Dedicated Reader Core = futur runtime multi-pass.
...
PostgreSQL `active=false`; €50,000 reste une valeur de planification.
