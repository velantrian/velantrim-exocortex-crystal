...
# Projet, financement et gouvernance

physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof. PostgreSQL reste `active=false`.

NLnet : submitted / under review / not awarded. Environ €50,000 est une estimation de planification; budget change: none.
...
RC-1/RC-2 sont une baseline pré-accord. Le Reader multi-pass dédié reste futur. Aucune certification security/legal/GDPR/native-speaker n’est revendiquée.
