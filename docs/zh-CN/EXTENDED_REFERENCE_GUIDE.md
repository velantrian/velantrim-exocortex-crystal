...
D5 区分 `CURRENT`、`RETIRED` 与 `ENGLISH_ONLY_BY_DESIGN`。physical L3 != strict Canon; retrieval score != evidence; model output != source truth; migration proof != claim proof; import success != activation。PostgreSQL `active=false`。
...
RC-1/RC-2 是已实现的 bounded foundation；dedicated multi-pass Reader 尚未实现。Grant: submitted / under review / not awarded; €50,000 planning only; budget change: none.
