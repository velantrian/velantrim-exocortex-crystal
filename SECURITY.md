...
The current verified baseline is `main@f03e24c85922d0bb46d6d9dfee98338972135908` (PR #335, CI `31224184351`). Evidence includes
...
PR #335 implements issue #331 with fixed cursor batches, incremental write/hash/count,
...
Benchmark `31224005804` is bounded local-first evidence, not a production SLO or arbitrary-scale
